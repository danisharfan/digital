...
<head>
    ...
    <title>Edit Pengaduan - Pengaduan Siswa</title>
...
<body>
    <div class="max-w-2xl mx-auto">
        <div class="form-card p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Edit Pengaduan</h1>
            ...
            <form action="{{ route('pengaduan.update', $pengaduan) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        required
                        class="form-textarea"
                    >{{ old('isi_laporan', $pengaduan->isi_laporan) }}</textarea>
                </div>
                ...
                <div class="mb-8">
                    ...
                    @if($pengaduan->foto)
                        <div class="mb-4">
                            ...
                            <img src="{{ Storage::url($pengaduan->foto) }}" alt="Foto pengaduan" class="current-photo">
                        </div>
                    @endif
                    <input
                        type="file"
                        ...
                        class="form-input"
                    />
                    <p class="text-sm text-gray-500 mt-2">Format: JPG, PNG, GIF. Maksimal 2MB. Biarkan kosong jika tidak ingin mengubah foto.</p>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('pengaduan.show', $pengaduan) }}" class="btn-secondary px-6 py-3 rounded-lg font-semibold">
