...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600&family=Syne:wght@600;700&display=swap"
        rel="stylesheet">
    <style>
        *,
        *::before,
        *::after {
        ...
        :root {
            --teal: #00a8cc;
            --teal-dark: #0d7377;
            --teal-light: rgba(0, 168, 204, 0.10);
            --teal-mid: rgba(0, 212, 255, 0.15);
        ...
        body {
            ...
            background: linear-gradient(135deg, #0d7377 0%, #00a8cc 35%, #00d4ff 70%, #0d7377 100%);
